...
class CharactersActivity : BaseActivity() {
    ...
    //1 private lateinit var binding: ActivityCharactersBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //1 binding = ActivityCharactersBinding.inflate(layoutInflater)
        setContentView(binding.root)
        setupRecyclerView()

        viewModel.getCharacters()
        viewModel.charactersLv.observeResource(
            success = {
        ...
        /*viewModel.charactersLv.observe(this) { state ->
            ...
            when (state) {
                ...
                is Resource.SuccLoading -> {
                    if (state.data != null) {
                        charactersAdapter.submitList(state.data.results)
                    }
                }
            }
        }*/
